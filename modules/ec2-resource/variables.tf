...
variable "instance" {
  ...
  type = object({
    ...
    name                        = string
    ami                         = string
    strategic_ami_build         = optional(string, "DEV")
    strategic_os_type           = optional(string, "NYL Amazon Linux 2023")
  ...
  validation {
    ...
    error_message = "instance.instance_type must use an approved family (${join(", ", local.approved_instance_families)}) and must not be a nano or small size."
  }
  validation {
